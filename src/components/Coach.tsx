...
const STEPS: Step[] = [
  {
    target: 'chart',
    title: '왼쪽은 이미 지나간 구간이에요',
    body: '파란 점선 자리가 다음에 열릴 봉이에요. 어떻게 생겼는지는 아직 아무도 몰라요.',
  },
  {
    target: 'actions',
    title: '여기서 하나 고르면 봉이 하나 열려요',
    body: '고른 주문은 그 봉의 시가에 체결돼요. 매수와 매도는 늘 전량이에요.',
  },
  {
    target: 'score',
    title: '점수는 수익률이 아니에요',
    body: '그냥 사서 끝까지 버틴 사람(존버)보다 얼마나 잘했는지가 점수예요. 매 턴 여기서 볼 수 있어요.',
  },
  {
    target: 'help',
    title: '막히면 여기를 누르세요',
